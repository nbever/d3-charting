...
import { BarNature, BarSpecInitProps } from '../charting/bar_nature';
import { StackedBarNature, StackedBarSpecInitProps } from '../charting/stacked_bar_nature';
...
export interface BarNatureSpec {
  nature: 'bar';
  specs: BarSpec<BarSpecInitProps>[];
  Nctor?: BarNature;
...
export interface StackedBarNatureSpec {
  nature: 'stackedBar';
  specs: BarSpec<StackedBarSpecInitProps>[];
...
export type ChartSpecs = LineSpec | BarSpec<StackedBarSpecInitProps> | AxisSpec | PointSpec;
